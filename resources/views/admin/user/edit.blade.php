<div class="modal-content border-0">
    ...
    <form class="tablelist-form" id="edit_category_form" action="{{ route('admin.users.update', $user->id) }}" method="POST">
        @csrf
        @method('put')
        <div class="modal-body">
            <div class="row g-3">
                ...
                <div class="col-lg-6">
                    ...
                    <input type="text" id="category_name" name="name" class="form-control" value="{{ $user->name }}" placeholder="{{ $title }} name">
